  ...
  return (
    <Card>
      ...
      <CardContent className="space-y-4">
        {googleMapsError && (
          <div className="bg-red-50 border border-red-200 rounded-md p-3 text-sm text-red-800">{googleMapsError}</div>
        )}
              ...
              <FormItem>
                ...
                <FormControl>
                  <Input
                    ...
                    ref={(el) => {
                      if (el && !autocompleteOrigin && isGoogleMapsLoaded && window.google?.maps?.places) {
              ...
              <FormItem>
                ...
                <FormControl>
                  <Input
                    ...
                    ref={(el) => {
                      if (el && !autocompleteDestination && isGoogleMapsLoaded && window.google?.maps?.places) {
