      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-12">
          <div className="md:col-span-2">
            <div className="flex items-center space-x-3 mb-6">
              ...
              <div>
                ...
                <span className="text-2xl font-bold text-primary ml-1">PERMIT</span>
              </div>
            </div>
            <p className="text-gray-300 mb-6 max-w-md leading-relaxed">
              Get connected to make your specialized transportation needs as easy as possible. Providing the fastest
          ...
          <div>
            ...
            <p className="text-gray-400 text-sm">Follow us for industry updates and transportation insights</p>
          </div>
        </div>

        <div className="border-t border-gray-700 mt-12 pt-8 flex flex-col md:flex-row items-center justify-between">
          <p className="text-gray-400 text-sm">&copy; 2024 Click Permit. All rights reserved.</p>
