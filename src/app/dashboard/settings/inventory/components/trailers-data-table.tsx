...
export function TrailersDataTable({ onSelect, selectedTrailerId }: TrailersDataTableProps) {
        ...
        <TableBody>
          {table.getRowModel().rows?.length ? (
            table.getRowModel().rows.map(row => (
              <TableRow
                key={row.id}
                data-state={row.original._id === selectedTrailerId && 'selected'}
            ...
            <TableRow>
              <TableCell colSpan={trailerColumns.length} className="h-24 text-center">
