  ...
  return (
    <div
      className={cn(
        ...
        isAsideOpen ? 'md:grid-cols-[220px_1fr] xl:grid-cols-[280px_1fr]' : 'md:!grid-cols-[70px_1fr]',
      )}
    >
      <DashboardAside />
      ...
      <div className="flex flex-col h-full overflow-x-hidden max-h-screen overflow-y-auto">
        ...
        <main className="flex relative flex-1 flex-col gap-4 p-4 lg:gap-6 lg:p-6">{children}</main>
      </div>
    </div>
  )
}
