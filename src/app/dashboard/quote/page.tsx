                ...
                <Table>
                  ...
                  <TableFooter>
                    <TableRow className="bg-primary-50 hover:bg-primary-50">
                      ...
                      <TableCell className="text-right font-bold text-primary-600">$203.10</TableCell>
                      ...
                      <TableCell className="text-right font-bold text-primary-600">$430.00</TableCell>
                      <TableCell className="text-right font-bold text-primary-600">$1219.71</TableCell>
                      <TableCell className="text-right font-bold text-primary-600">349.4 mi</TableCell>
                      <TableCell className="text-right font-bold text-primary-600 text-xl">$1852.81</TableCell>
                    </TableRow>
                  </TableFooter>
                </Table>
              </div>
