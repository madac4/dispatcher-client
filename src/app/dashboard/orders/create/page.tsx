                  ...
                  {!truck && (
                    <EntitySelectModal type="truck" onSelect={handleTruckSelect}>
                      <div className="border-2 border-dashed border-gray-300 rounded-xl p-6 text-center hover:border-orange-400 hover:bg-orange-50/20 transition-all duration-200">
                        ...
                        <h3 className="text-lg font-semibold text-gray-900 mb-2">No Truck Selected</h3>
                        <p className="text-gray-500 mb-3">Choose a truck from your fleet inventory</p>
                    ...
                    <div className="relative bg-blue-50 rounded-xl p-4 border border-blue-500">
                      <div className="mb-3 flex items-center justify-between">
                        <div className="flex items-center space-x-3 mb-2">
                          ...
                          <div>
                            <h3 className="text-lg font-bold text-gray-900">Unit #{truck.unitNumber}</h3>
                  ...
                  {!trailer && (
                    <EntitySelectModal type="trailer" onSelect={handleTrailerSelect}>
                      <div className="border-2 border-dashed border-gray-300 rounded-xl p-6 text-center hover:border-orange-400 hover:bg-orange-50/20 transition-all duration-200">
                        ...
                        <h3 className="text-lg font-semibold text-gray-900 mb-2">No Trailer Selected</h3>
                        <p className="text-gray-500 mb-3">Choose a trailer from your fleet inventory</p>
                  ...
                  {trailer && (
                    <div className="relative bg-purple-50 rounded-xl p-4 border border-purple-500">
                        ...
                        <div className="flex items-center space-x-3 mb-2">
                          ...
                          <div>
                            <h3 className="text-lg font-bold text-gray-900">
                              {trailer.unitNumber ? `Unit #${trailer.unitNumber}` : 'Trailer'}
                            </h3>
                      ...
                      <div className="grid grid-cols-2 gap-3">
                        <div className="bg-white/70 rounded-lg p-2 space-y-1">
                          <h6 className="text-xs font-medium text-gray-600 uppercase">License Plate</h6>
                          <p className="font-semibold text-gray-900">{trailer.licencePlate || '—'}</p>
                        </div>
                        <div className="bg-white/70 rounded-lg p-2 space-y-1">
                          <h6 className="text-xs font-medium text-gray-600 uppercase">State</h6>
                          <p className="font-semibold text-gray-900">{trailer.state || '—'}</p>
                        </div>
                        <div className="bg-white/70 rounded-lg p-2 space-y-1">
                          <h6 className="text-xs font-medium text-gray-600 uppercase">Length</h6>
                          <p className="font-semibold text-gray-900">{trailer.length ? `${trailer.length}` : '—'}</p>
                        </div>
                        <div className="bg-white/70 rounded-lg p-2 space-y-1">
                        ...
                        <div className="bg-white/70 rounded-lg p-2 space-y-1">
                          <h6 className="text-xs font-medium text-gray-600 uppercase">Axles</h6>
                          <p className="font-semibold text-gray-900">{trailer.nrOfAxles || '—'}</p>
                        </div>
                        <div className="bg-white/70 rounded-lg p-2 space-y-1">
                          <h6 className="text-xs font-medium text-gray-600 uppercase">VIN Number</h6>
                  ...
                  <FormField
                    ...
                    render={({ field }) => (
                      <FormItem>
                        ...
                        <FormControl>
                          <Input placeholder="Enter load dimensions" {...field} className="bg-white font-medium" />
                        </FormControl>
                        <FormMessage />
                      </FormItem>
                    )}
                    ...
                    <div className="min-h-[80px] border-2 border-dashed rounded-lg p-4">
                      {field.value && Array.isArray(field.value) && field.value.length > 0 ? (
                        ...
                        <div className="flex flex-col items-center justify-center text-gray-500 space-y-1">
                          ...
                          <div className="text-xs text-gray-400">Maximum file size: 10MB per file</div>
                        </div>
                      )}
                                  ...
                                  <Input
                                    ...
                                    onChange={e => {
                                      ...
                                      if (oversizedFiles.length > 0) {
                                        ...
                                        toast.error(`Files larger than 10MB: ${fileNames}`)
                                        return
                                      }
