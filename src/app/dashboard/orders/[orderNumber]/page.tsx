      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
            ...
            <CardContent className="space-y-6">
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                ...
                <div className="space-y-4">
                  ...
                  <div>
                    <label className="text-sm font-medium text-gray-600">Legal Weight</label>
                    <Badge variant={order.legalWeight === 'yes' ? 'default' : 'destructive'}>
                      {order.legalWeight === 'yes' ? 'Yes' : 'No'}
                    </Badge>
                  </div>
                </div>
              </div>
        ...
        <div className="space-y-6">
          ...
          <Card>
            ...
            <CardContent className="space-y-4">
              <Textarea placeholder="Type your message" className="min-h-[80px] resize-none" />
